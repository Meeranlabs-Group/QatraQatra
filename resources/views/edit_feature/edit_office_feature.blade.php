        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <ul class="checkboxes inline half list-unstyled">
                    ...
                    <li><div class="form-group width-60">
                            <input type="text" name="Number_of_Store_Rooms" value="{{ $feature[0]->feature->number_of_store_rooms}}">
                    ...
                    <li><div class="form-group width-60">
                            <input type="text" name="Number_of_Servant_Quarters" value="{{ $feature[0]->feature->number_of_servant_quaters }}">
                    ...
                    <li><div class="form-group width-60">
                            <input type="text" name="Other_Rooms" value="{{ $feature[0]->feature->other_room }}">
            ...
            <div class="col-md-6">
                ...
                <ul class="checkboxes inline half list-unstyled">
                    ...
                    @if($feature[0]->feature->lawn_or_garden)
