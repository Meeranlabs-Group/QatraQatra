        ...
        <div class="col-md-6">
            ...
            <ul class="checkboxes inline half list-unstyled">
                ...
                @endif
                    ...
                    @if($feature[0]->feature->water_supply)
                    ...
                    @if($feature[0]->feature->boundry_wall)
                ...
                <li><div class="form-group width-60">
                        <input type="text" name="Other_Plot_Features" value="{{ $feature[0]->feature->other_plot_features }}">
