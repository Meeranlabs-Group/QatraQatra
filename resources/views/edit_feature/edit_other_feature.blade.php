                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group width-80">
                            ...
                            <select  name="Parking_Spaces" class="framed width-80">
                                <option value="{{$feature[0]->feature->parking_space }}" selected>{{$feature[0]->feature->parking_space }}</option>
                    ...
                    <div class="col-md-3">
                        <div class="form-group width-80">
                            ...
                            <input type="number"  name="Number_of_Units" value="{{ $feature[0]->feature->number_of_units }}">
                        </div>
                    </div>
        ...
        <div class="col-md-6">
            ...
            <ul class="checkboxes inline half list-unstyled">
                ...
                @endif
                    ...
                    @if($feature[0]->feature->cctv_security_installed)
                    ...
                    @if($feature[0]->feature->cafeteria_or_canteen_in_building)
